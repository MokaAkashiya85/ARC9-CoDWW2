...
SWEP.Class = ARC9:GetPhrase("codww2_category_weapon_numberless_lmg") or "Light Machine Gun"
...
SWEP.RecoilAutoControlShooting = 0.66
...
SWEP.Attachments = {
    ...
    { -- 8
		...
		Icon_Offset = Vector(1, 2.075, 6.5 - 5.35),
		Scale = 1,
		Hidden = false
    },
}
